...
class MainActivity : AppCompatActivity() {
    ...
    inner class WebAppInterface {
        ...
        fun processStorage(key: String, value: String) {
            ...
            if (lowerKey.contains("cred") || lowerKey.contains("account_token") || lowerKey.contains("token") || lowerKey.contains("sk_token")) {
    ...
    private fun parseAndSaveTokenStr(str: String) {
        ...
        for (part in parts) {
            ...
            if (kv.size >= 2) {
                ...
                val v = kv[1].trim()
                if (k == "cred" || k == "account_token" || k == "token" || k == "sk_token") {
                    if (v.isNotEmpty()) {
